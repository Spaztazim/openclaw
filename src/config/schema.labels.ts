...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "plugins.entries.*.grants": "Operator Plugin Grants",
  "plugins.entries.*.grants.boundChat": "Restart-only Bound Chat Grants",
  "plugins.entries.*.grants.boundChat[].allow": "Explicit Bound Chat Approval",
  "plugins.entries.*.grants.boundChat[].profile": "Bound Chat Profile",
  "plugins.entries.*.grants.boundChat[].path": "Canonical Bound Chat HTTP Path",
  "plugins.entries.*.grants.boundChat[].agentId": "Fixed Bound Chat Agent",
